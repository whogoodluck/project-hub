    ...
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <nav className="relative flex items-center justify-between px-6 py-5 sm:px-12">
        ...
        <div className="flex items-center gap-3">
          {isAuthenticated ? (
            ...
            <>
              <Button asChild variant="ghost" size="sm" className="font-mono text-xs uppercase">
      ...
      <main className="relative px-6 pb-24 pt-20 text-center sm:px-12 sm:pt-32">
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Button asChild size="lg" className="px-8 font-mono font-bold tracking-widest uppercase">
            <Link to="/signup">Start free →</Link>
          </Button>
          <Button asChild size="lg" variant="outline" className="font-mono text-sm uppercase">
            <Link to="/signin">Sign in</Link>
          </Button>
        </div>
